---
title: "Album Review: Vince Staples by Vince Staples"
date: 2021-07-15T06:08:24.853Z
subtitle: Staples paints a self-portrait in his most focused release to date.
webp: /img/vinceself.webp
jpg: /img/vinceself.jpg
alt: Vince Staples Album art
slug: /blog/staples-review
tags:
  - music
  - review
---
...
In Staples’ previous project, FM!, he presented a tongue-in-cheek critique to this dismissive listening by juxtapositioning grim lyrics with playful beats and radio tags. With his new self-titled work, however, Staples seems to go the opposite direction: he trades the playful and energetic commentary for a delivery that’s sobering and direct. With Vince Staples, he makes sure the listener is paying attention to what he has to say.
...
The production, done by Kenny Beats, matches the tone of the lyrics and delivery. Most songs on the album are more mellow and melodic than the rest in Staples’ discography, but each track has a unique groove that manages to become an earworm. The songs themselves range enough to keep a listener interested (from the quasi-ballad “Are You With That?” to the bouncy Monte Booker co-produced “Taking Trips”) but retain the same motifs which keep the project concise.

Totaling at just shy over 20 minutes, Vince Staples's self-titled is all meat and no filler. The project is short enough with the right amount of replayability, allowing a listener to make consecutive playthroughs without getting tired. With each listen, you grow a deeper connection with Staples’ stories and feelings. Even if you’re not from the same background, you begin to better empathize with what he went through as he paints a fuller picture of his point of view. It’s unavoidable, but that’s exactly what Staples wanted.